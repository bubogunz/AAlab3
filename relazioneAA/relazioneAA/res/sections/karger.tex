...
La procedura \texttt{Karger} ha una complessità di\comp{n^4 \log n}, infatti è possibile vedere in Figura~\ref{k-results} come rispetto a Figura~\ref{fc-results}, che si riferisce ad una curva asintotica di \comp{n^2}, la inizi ad impennarsi circa con grafi di 100 nodi, ma in modo più ripido.
